...
class MutableCFConfig(initConfig: CFConfig) {
    ...
    val clientKey: String get() = _config.clientKey
    val dimensionId: String? get() = _config.dimensionId
    val offlineMode: Boolean get() = _config.offlineMode
    val eventsQueueSize: Int get() = _config.eventsQueueSize
    val eventsFlushTimeSeconds: Int get() = _config.eventsFlushTimeSeconds
    val eventsFlushIntervalMs: Long get() = _config.eventsFlushIntervalMs
    val summariesQueueSize: Int get() = _config.summariesQueueSize
    val summariesFlushTimeSeconds: Int get() = _config.summariesFlushTimeSeconds
    val summariesFlushIntervalMs: Long get() = _config.summariesFlushIntervalMs
    val sdkSettingsCheckIntervalMs: Long get() = _config.sdkSettingsCheckIntervalMs
    val networkConnectionTimeoutMs: Int get() = _config.networkConnectionTimeoutMs
    ...
    val backgroundPollingIntervalMs: Long get() = _config.backgroundPollingIntervalMs
    val useReducedPollingWhenBatteryLow: Boolean get() = _config.useReducedPollingWhenBatteryLow
    val reducedPollingIntervalMs: Long get() = _config.reducedPollingIntervalMs
    val maxStoredEvents: Int get() = _config.maxStoredEvents
