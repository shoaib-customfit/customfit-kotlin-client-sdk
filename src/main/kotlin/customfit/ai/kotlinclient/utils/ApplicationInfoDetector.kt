...
object ApplicationInfoDetector {
    ...
    fun detectApplicationInfo(forceRefresh: Boolean = false): ApplicationInfo? {
        ...
        try {
            ...
            val buildType = System.getProperty("java.vm.version")?.let {
    ...
    private fun getApplicationName(): String? {
        ...
        System.getProperty("application.name")?.let { return it }
        ...
        return try {
            val mainClassName = StackWalker.getInstance(StackWalker.Option.RETAIN_CLASS_REFERENCE)
